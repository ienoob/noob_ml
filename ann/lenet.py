...
def dataset_loader():
    train_image = read_image(r'D:\data\cv\mnist\train-images.idx3-ubyte')
    train_label = read_label(r'D:\data\cv\mnist\train-labels.idx1-ubyte')
    test_image = read_image(r'D:\data\cv\mnist\t10k-images.idx3-ubyte')
    test_label = read_label(r'D:\data\cv\mnist\t10k-labels.idx1-ubyte')
